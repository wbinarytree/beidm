		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_min_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_min_time_feature", "_UI_Transition_type"),
				 PetriNetPackage.Literals.TRANSITION__MIN_TIME,
				 true,
				 false,
				 false,
	...
	protected void addMax_timePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_max_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_max_time_feature", "_UI_Transition_type"),
				 PetriNetPackage.Literals.TRANSITION__MAX_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
