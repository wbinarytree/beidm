	...
	protected void addOccurencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_occurence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_occurence_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__OCCURENCE,
				 true,
				 false,
				 false,
