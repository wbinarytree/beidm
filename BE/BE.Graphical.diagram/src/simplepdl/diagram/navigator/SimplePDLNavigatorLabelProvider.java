...
public class SimplePDLNavigatorLabelProvider extends LabelProvider implements
	 ...
	 * @generated
	 */
	private String getRessourceInstance_4001Text(View view) {
		RessourceInstance domainModelElement = (RessourceInstance) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.getInstances());
		} else {
	 ...
	 * @generated
	 */
	private String getGuidance_2004Text(View view) {
		IParser parser = SimplePDLParserProvider.getParser(
				SimplePDLElementTypes.Guidance_2004,
	 ...
	 * @generated
	 */
	private String getRessourceDefinition_2001Text(View view) {
		IParser parser = SimplePDLParserProvider.getParser(
				SimplePDLElementTypes.RessourceDefinition_2001, view
