...
import simplepdl.diagram.edit.policies.SimplePDLTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RessourceDefinitionNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RessourceDefinitionNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SimplePDLTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return SimplePDLElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplePDLParserProvider
					.getParser(
							SimplePDLElementTypes.RessourceDefinition_2001,
							getParserElement(),
							SimplePDLVisualIDRegistry
									.getType(simplepdl.diagram.edit.parts.RessourceDefinitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SimplePDLEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
