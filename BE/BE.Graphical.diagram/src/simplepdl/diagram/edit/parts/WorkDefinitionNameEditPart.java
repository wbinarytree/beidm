 ...
 * @generated
 */
public class WorkDefinitionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WorkDefinitionNameEditPart(View view) {
		super(view);
	}
			...
			parser = SimplePDLParserProvider
					.getParser(
							...
							SimplePDLVisualIDRegistry
									.getType(simplepdl.diagram.edit.parts.WorkDefinitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
