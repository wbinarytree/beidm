...
import simplepdl.diagram.edit.commands.RessourceInstanceCreateCommand;
import simplepdl.diagram.edit.commands.RessourceInstanceReorientCommand;
import simplepdl.diagram.edit.commands.WorkSequenceCreateCommand;
import simplepdl.diagram.edit.commands.WorkSequenceReorientCommand;
 ...
 * @generated
 */
public class WorkDefinitionItemSemanticEditPolicy extends
		SimplePDLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public WorkDefinitionItemSemanticEditPolicy() {
		super(SimplePDLElementTypes.WorkDefinition_2003);
	}
	...
	protected Command getReorientRelationshipCommand(
		...
		case RessourceInstanceEditPart.VISUAL_ID:
			return getGEFWrapper(new RessourceInstanceReorientCommand(req));
		case WorkSequenceEditPart.VISUAL_ID:
			return getGEFWrapper(new WorkSequenceReorientCommand(req));
		}
