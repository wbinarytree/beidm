...
protected class Process_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_RightCurlyBracketKeyword_9(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "min_time"
protected class Process_Min_timeKeyword_4 extends KeywordToken  {
	
	public Process_Min_timeKeyword_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getProcessAccess().getMin_timeKeyword_4();
	}
...
// min_time=EInt
protected class Process_Min_timeAssignment_5 extends AssignmentToken  {
	
	public Process_Min_timeAssignment_5(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getProcessAccess().getMin_timeAssignment_5();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_Min_timeKeyword_4(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getProcessAccess().getMin_timeEIntParserRuleCall_5_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getProcessAccess().getMin_timeEIntParserRuleCall_5_0();
			return obj;
		}
		return null;
	}
...
// "max_time"
protected class Process_Max_timeKeyword_6 extends KeywordToken  {
	
	public Process_Max_timeKeyword_6(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getProcessAccess().getMax_timeKeyword_6();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_Min_timeAssignment_5(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// max_time=EInt
protected class Process_Max_timeAssignment_7 extends AssignmentToken  {
	
	public Process_Max_timeAssignment_7(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getProcessAccess().getMax_timeAssignment_7();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_Max_timeKeyword_6(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getProcessAccess().getMax_timeEIntParserRuleCall_7_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getProcessAccess().getMax_timeEIntParserRuleCall_7_0();
			return obj;
		}
		return null;
	}
...
// (processElements+=ProcessElement processElements+=ProcessElement*)?
protected class Process_Group_8 extends GroupToken {
	
	public Process_Group_8(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getProcessAccess().getGroup_8();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_ProcessElementsAssignment_8_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Process_ProcessElementsAssignment_8_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// processElements+=ProcessElement
protected class Process_ProcessElementsAssignment_8_0 extends AssignmentToken  {
	
	public Process_ProcessElementsAssignment_8_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getProcessAccess().getProcessElementsAssignment_8_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getProcessElementRule().getType().getClassifier())) {
				...
				element = grammarAccess.getProcessAccess().getProcessElementsProcessElementParserRuleCall_8_0_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		...
		switch(index) {
			case 0: return new Process_Max_timeAssignment_7(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// processElements+=ProcessElement*
protected class Process_ProcessElementsAssignment_8_1 extends AssignmentToken  {
	
	public Process_ProcessElementsAssignment_8_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getProcessAccess().getProcessElementsAssignment_8_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getProcessElementRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getProcessAccess().getProcessElementsProcessElementParserRuleCall_8_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Process_ProcessElementsAssignment_8_1(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new Process_ProcessElementsAssignment_8_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "}"
protected class Process_RightCurlyBracketKeyword_9 extends KeywordToken  {
	
	public Process_RightCurlyBracketKeyword_9(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getProcessAccess().getRightCurlyBracketKeyword_9();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Process_Group_8(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Process_Max_timeAssignment_7(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class Guidance_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Guidance_TextAssignment_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// 		('element' '(' element+=[ProcessElement|EString] ( "," element+=[ProcessElement|EString])* ')' )?
// 	'}'* / text=STRING
protected class Guidance_TextAssignment_1 extends AssignmentToken  {
	
	public Guidance_TextAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getGuidanceAccess().getTextAssignment_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getGuidanceAccess().getTextSTRINGTerminalRuleCall_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getGuidanceAccess().getTextSTRINGTerminalRuleCall_1_0();
			return obj;
		}
		return null;
	}
