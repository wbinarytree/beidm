...
public class SimplePDLElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Process_1000 = getElementType("BE.diagram.Process_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Ressource_2001 = getElementType("BE.diagram.Ressource_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Guidance_2002 = getElementType("BE.diagram.Guidance_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkDefinition_2003 = getElementType("BE.diagram.WorkDefinition_2003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkSequence_4001 = getElementType("BE.diagram.WorkSequence_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Ressource_2001,
					SimplepdlPackage.eINSTANCE.getRessource());
			...
			elements.put(WorkSequence_4001,
