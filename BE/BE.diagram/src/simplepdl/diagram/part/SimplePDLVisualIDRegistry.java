...
public class SimplePDLVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "BE.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case ProcessEditPart.VISUAL_ID:
			if (SimplepdlPackage.eINSTANCE.getRessource().isSuperTypeOf(
					domainElement.eClass())) {
				return RessourceEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		switch (containerVisualID) {
		case ProcessEditPart.VISUAL_ID:
			if (RessourceEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case RessourceEditPart.VISUAL_ID:
			if (RessourceNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
