 ...
 * @generated
 */
public class RessourceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RessourceNameEditPart(View view) {
		super(view);
	}
			...
			parser = SimplePDLParserProvider
					.getParser(
							...
							SimplePDLVisualIDRegistry
									.getType(simplepdl.diagram.edit.parts.RessourceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
