 ...
 * @generated
 */
public class WorkSequenceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public WorkSequenceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return SimplePDLBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateWorkSequence_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		WorkSequence newElement = SimplepdlFactory.eINSTANCE
				.createWorkSequence();
		getContainer().getProcessElements().add(newElement);
		newElement.setPredecessor(getSource());
		newElement.setSuccessor(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(WorkSequence newElement,
