...
public class SimplePDLNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case WorkSequenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://simplepdl?WorkSequence", SimplePDLElementTypes.WorkSequence_4001); //$NON-NLS-1$
		...
		case RessourceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://simplepdl?Ressource", SimplePDLElementTypes.Ressource_2001); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private String getWorkSequence_4001Text(View view) {
	 ...
	 * @generated
	 */
	private String getWorkDefinition_2003Text(View view) {
		IParser parser = SimplePDLParserProvider.getParser(
				SimplePDLElementTypes.WorkDefinition_2003,
				view.getElement() != null ? view.getElement() : view,
				SimplePDLVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getRessource_2001Text(View view) {
		IParser parser = SimplePDLParserProvider.getParser(
				SimplePDLElementTypes.Ressource_2001,
				view.getElement() != null ? view.getElement() : view,
				SimplePDLVisualIDRegistry
