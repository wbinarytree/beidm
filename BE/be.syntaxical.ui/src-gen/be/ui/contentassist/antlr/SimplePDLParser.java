		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcessAccess().getMin_timeAssignment_5(), "rule__Process__Min_timeAssignment_5");
					put(grammarAccess.getProcessAccess().getMax_timeAssignment_7(), "rule__Process__Max_timeAssignment_7");
					put(grammarAccess.getProcessAccess().getProcessElementsAssignment_8_0(), "rule__Process__ProcessElementsAssignment_8_0");
					put(grammarAccess.getProcessAccess().getProcessElementsAssignment_8_1(), "rule__Process__ProcessElementsAssignment_8_1");
