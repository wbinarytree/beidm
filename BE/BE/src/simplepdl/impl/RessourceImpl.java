 ...
 *   <li>{@link simplepdl.impl.RessourceImpl#getOccurence <em>Occurence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RessourceImpl extends EObjectImpl implements Ressource {
	/**
	...
	public void setOccurence(int newOccurence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESSOURCE__OCCURENCE, oldOccurence, occurence));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplepdlPackage.RESSOURCE__NAME:
				return getName();
			case SimplepdlPackage.RESSOURCE__OCCURENCE:
				return getOccurence();
		}
