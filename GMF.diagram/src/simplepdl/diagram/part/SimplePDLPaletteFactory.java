...
public class SimplePDLPaletteFactory {
	...
	private ToolEntry createWorkDefinition1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(SimplePDLElementTypes.WorkDefinition_2002));
		entry.setId("createWorkDefinition1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SimplePDLElementTypes
				.getImageDescriptor(SimplePDLElementTypes.WorkDefinition_2002));
	...
	private ToolEntry createGuidance3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections.singletonList(SimplePDLElementTypes.Guidance_2001));
		entry.setId("createGuidance3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SimplePDLElementTypes
				.getImageDescriptor(SimplePDLElementTypes.Guidance_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createGuidanceElement4CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(SimplePDLElementTypes.GuidanceElement_4001));
		entry.setId("createGuidanceElement4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(SimplePDLElementTypes
				.getImageDescriptor(SimplePDLElementTypes.GuidanceElement_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
