...
public class SimplePDLNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case WorkDefinitionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://simplepdl?WorkDefinition", SimplePDLElementTypes.WorkDefinition_2002); //$NON-NLS-1$
		...
		case GuidanceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://simplepdl?Guidance", SimplePDLElementTypes.Guidance_2001); //$NON-NLS-1$
		}
	 ...
	 * @generated
	 */
	private String getGuidance_2001Text(View view) {
	 ...
	 * @generated
	 */
	private String getWorkDefinition_2002Text(View view) {
		IParser parser = SimplePDLParserProvider.getParser(
