...
public class SimplePDLParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser guidanceText_5001Parser;

	/**
	 * @generated
	 */
	private IParser getGuidanceText_5001Parser() {
		if (guidanceText_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { SimplepdlPackage.eINSTANCE
					.getGuidance_Text() };
			MessageFormatParser parser = new MessageFormatParser(features);
			guidanceText_5001Parser = parser;
		}
		return guidanceText_5001Parser;
	}

	/**
	 * @generated
	 */
	private IParser workDefinitionName_5002Parser;

	/**
	 * @generated
	 */
	private IParser getWorkDefinitionName_5002Parser() {
		if (workDefinitionName_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { SimplepdlPackage.eINSTANCE
					.getWorkDefinition_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			workDefinitionName_5002Parser = parser;
		}
		return workDefinitionName_5002Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case GuidanceTextEditPart.VISUAL_ID:
			return getGuidanceText_5001Parser();
		case WorkDefinitionNameEditPart.VISUAL_ID:
			return getWorkDefinitionName_5002Parser();
		}
		return null;
	}
