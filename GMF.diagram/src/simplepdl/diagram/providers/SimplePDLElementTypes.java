...
public class SimplePDLElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Process_1000 = getElementType("GMF.diagram.Process_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Guidance_2001 = getElementType("GMF.diagram.Guidance_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkDefinition_2002 = getElementType("GMF.diagram.WorkDefinition_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType GuidanceElement_4001 = getElementType("GMF.diagram.GuidanceElement_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkSequence_4002 = getElementType("GMF.diagram.WorkSequence_4002"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Guidance_2001,
					SimplepdlPackage.eINSTANCE.getGuidance());

			elements.put(WorkDefinition_2002,
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Guidance_2001);
			KNOWN_ELEMENT_TYPES.add(WorkDefinition_2002);
	...
	public static IElementType getElementType(int visualID) {
		...
		case GuidanceEditPart.VISUAL_ID:
			return Guidance_2001;
		case WorkDefinitionEditPart.VISUAL_ID:
			return WorkDefinition_2002;
