 ...
 * @generated
 */
public class GuidanceTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GuidanceTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplePDLParserProvider
					.getParser(
							SimplePDLElementTypes.Guidance_2001,
							getParserElement(),
							SimplePDLVisualIDRegistry
									.getType(simplepdl.diagram.edit.parts.GuidanceTextEditPart.VISUAL_ID));
		}
		return parser;
	}
