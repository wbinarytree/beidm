...
public class SimplePDLElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Process_1000 = getElementType("tp4.diagram.Process_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkDefinition_2001 = getElementType("tp4.diagram.WorkDefinition_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Guidance_2002 = getElementType("tp4.diagram.Guidance_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType GuidanceElement_4001 = getElementType("tp4.diagram.GuidanceElement_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkSequence_4002 = getElementType("tp4.diagram.WorkSequence_4002"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(WorkDefinition_2001,
					SimplepdlPackage.eINSTANCE.getWorkDefinition());

			elements.put(Guidance_2002,
					SimplepdlPackage.eINSTANCE.getGuidance());

			elements.put(GuidanceElement_4001,
					SimplepdlPackage.eINSTANCE.getGuidance_Element());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(WorkDefinition_2001);
			KNOWN_ELEMENT_TYPES.add(Guidance_2002);
			KNOWN_ELEMENT_TYPES.add(GuidanceElement_4001);
	...
	public static IElementType getElementType(int visualID) {
		...
		case WorkDefinitionEditPart.VISUAL_ID:
			return WorkDefinition_2001;
		case GuidanceEditPart.VISUAL_ID:
			return Guidance_2002;
		case GuidanceElementEditPart.VISUAL_ID:
			return GuidanceElement_4001;
