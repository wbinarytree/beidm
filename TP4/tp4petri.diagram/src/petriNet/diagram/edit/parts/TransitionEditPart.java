...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new petriNet.diagram.edit.policies.TransitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof petriNet.diagram.edit.parts.TransitionNameEditPart) {
			((petriNet.diagram.edit.parts.TransitionNameEditPart) childEditPart)
