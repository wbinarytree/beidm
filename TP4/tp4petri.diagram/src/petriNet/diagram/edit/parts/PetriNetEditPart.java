...
public class PetriNetEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new petriNet.diagram.edit.policies.PetriNetItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new petriNet.diagram.edit.policies.PetriNetCanonicalEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						petriNet.diagram.part.PetriNetVisualIDRegistry.TYPED_INSTANCE));
