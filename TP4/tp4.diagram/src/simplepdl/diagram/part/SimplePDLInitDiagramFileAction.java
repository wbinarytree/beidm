 ...
 * @generated
 */
public class SimplePDLInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SimplePDLNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProcessEditPart.MODEL_ID));
		SimplePDLDiagramEditorUtil.runWizard(getShell(), wizard,
