...
import simplepdl.diagram.edit.policies.ProcessCanonicalEditPolicy;
import simplepdl.diagram.edit.policies.ProcessItemSemanticEditPolicy;
...
public class ProcessEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "SimplePDL"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						SimplePDLVisualIDRegistry.TYPED_INSTANCE));
