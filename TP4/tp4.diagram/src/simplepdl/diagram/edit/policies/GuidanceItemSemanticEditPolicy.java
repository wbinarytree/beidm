 ...
 * @generated
 */
public class GuidanceItemSemanticEditPolicy extends
		SimplePDLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public GuidanceItemSemanticEditPolicy() {
		super(SimplePDLElementTypes.Guidance_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SimplePDLVisualIDRegistry.getVisualID(outgoingLink) == GuidanceElementEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
