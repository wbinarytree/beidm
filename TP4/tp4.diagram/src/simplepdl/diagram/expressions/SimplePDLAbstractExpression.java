 ...
 * @generated
 */
public abstract class SimplePDLAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SimplePDLDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SimplePDLAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
