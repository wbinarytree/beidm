...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   * @see fr.enseeiht.pDL1.PDL1Package#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static PDL1Package init()
  {
    ...
    PDL1PackageImpl thePDL1Package = (PDL1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PDL1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PDL1PackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(processEClass, fr.enseeiht.pDL1.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, fr.enseeiht.pDL1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_ProcessElements(), this.getProcessElement(), null, "processElements", null, 0, -1, fr.enseeiht.pDL1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
